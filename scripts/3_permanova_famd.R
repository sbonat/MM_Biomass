...
plot1 <-  fviz_famd(famd1,
  ...
  # geom_text_repel(box.padding = 0.5, max.overlaps = Inf)+
          labs(x = "Axis 1 (14.1%)",
               y = "Axis 2 (12.2%)",
               title = "FAMD for biomass loss, with 95%CI ellipses around centroids for carcass treatment")+
          theme(
...
plot2 <-  fviz_famd(famd1,
  ...
  labs(x = "Axis 1 (14.1%)",
       y = "Axis 2 (12.2%)",
       title = "FAMD for biomass loss, with 95%CI ellipses around centroids for sampling period")+ theme(
         legend.position = c(.95, .95),
         legend.justification = c("right", "top"),
         legend.box.just = "right",
         legend.margin = margin(6, 6, 6, 6),
