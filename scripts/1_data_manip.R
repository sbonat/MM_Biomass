...
scav_data <- merge(invert_biomass, vert1, 
  ...
  mutate(site = as.factor(site),
         ...
         beetle_n_cat = factor(beetle_n_cat,
                               ...
                               labels = c("< 9 Beetles", "10 - 18 Beetles", "19 - 45 Beetles",
                                          "46 - 78 Beetles", "79 - 182 Beetles", "> 183 Beetles")
         ),
         fly_n_cat = factor(fly_n_cat,
                            levels = c("[3,9]", "(9,20]", "(20,39]", "(39,74]", "(74,127]", "(127,449]"),
                            labels = c("< 9 Flies", "10 - 20 Flies", "21 - 39 Flies", "40 - 74 Flies",
                                       "75 - 127 Flies", "> 128  Flies"))
        ) 
